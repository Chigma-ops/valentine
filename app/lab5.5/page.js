            ...
            <div className="flex justify-center">
                <div className="grid  lg:grid-cols-1 gap-10">
                    {exampleData.map((element) => (
                        <div 
                            key={element.id} 
                            className="flex flex-col p-5 rounded-lg text-white shadow-md w-60 h-auto border-white border shadow-xl shadow-blue-500 transition-transform duration-300 transform hover:scale-105"
                        >
